...
% \renewcommand\thesection{\makebox[0.8em][l]{S}\arabic{section}}
...
\renewcommand*\l@section[2]{%
  \ifnum \c@tocdepth >\z@
    ...
    \begingroup
      ...
      \hskip -\leftskip
      % Insert "S" before the section number
      #1\nobreak\hfil \nobreak\hb@xt@\@pnumwidth{\hss #2}\par
      \addvspace{1.15em}% Adjust space after each entry (double space)
    \endgroup
  \fi}
% Similar redefinition can be done for \l@subsection if needed.
\makeatother
