...
<<PlotEpiDist, echo=FALSE, fig.cap="Compare to Figure S8 of Lee et al. (2020) supplement.", fig.width=7, fig.height=7, fig.align='center',message=FALSE,warning=FALSE>>=
GGally::ggpairs(
  h1LeeStartsEpi,
...
<<plotEndParams, fig.width=7, fig.height=7, fig.align='center', fig.cap="Bivariate relationships between variables after fitting endemic period. Compare to S9 of Lee et al. (2020) supplement.", cache=TRUE, echo=FALSE,warning=FALSE>>=
GGally::ggpairs(
  h1LeeStartsEnd,
  columns = c("rho", "tau", "beta1", "nu", "loglik")
)
