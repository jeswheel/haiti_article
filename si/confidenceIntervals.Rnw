...
@
\caption{\label{m2Profs}MCAP confidence intervals for Model 2 parameters.}
\end{figure}
...
@
\caption{\label{m3Profs}MCAP confidence intervals for Model 1 parameters.}
\end{figure}
