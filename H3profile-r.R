...
reg <- makeExperimentRegistry(
  file.dir = paste0('model3/profileReg_r_RL', RUN_LEVEL),
  seed = 739164,
...
for (pp in prof_params) {
  ...
  if (pp == "mu_B") {
    ...
    prof_values <- c(seq(0.01, .55, 0.04), seq(1.5+0.04, 2.1, 0.04))
  } else if (pp == 'std_W') {
...
resources1 <- list(account = 'ionides2', walltime = '7:00:00', memory = '9000m', ncpus = 1)
...
# saveRDS(
#   h3_results,
#   paste0('model3/run_level_', RUN_LEVEL, '/', 'h3_r_profile.rds')
# )
#
