...
\new{The possibility of controlling the Haiti cholera outbreak via OCV was considered by various research groups \cite{ivers17,andrews11,walton11,matias17,chao11,fung13,date11,leung22,azman15}}.
...
\new{Confidence intervals for model parameters are given in Supplement S8.}
...
The large increase in the log-likelihood for Model~1 (see Table~\ref{tab:likes}) can primarily be attributed to increasing the computational effort in fitting the model.
...
% \TODO{Possibly add more citations to the diagnostics part, maybe li23, laneri10 (Forcing Versus Feedback: Epidemic Malaria and Monsoon Rains in Northwest India), pons-salort18}
...
This result hints at the possibility of model mispecification, and should prompt us to be \old{sceptical} \new{skeptical} of the reliability of forecasts from this model.
