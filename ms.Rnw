...
Specifically, we present approaches of diagnosing model misspecification \old{, development of alternative models, and computational improvements in optimization, in the context of likelihood-based inference on nonlinear dynamic systems.} \new{and the consequent development of improved models.
...
\new{In this article, we use an in-depth case study to motivate general procedures for fitting mathematical models to time series data, while explaining how these procedures help to address limitations of previous approaches.}
...
\TODO{Add citations from lit-review.}
...
Likelihoods of Models~1--3 and their respective \old{ARMA} benchmark models are provided in Table~\ref{tab:likes}.
...
\TODO{Citations from lit-review}.
...
\TODO{Re-phrase this paragraph, as suggested by one of the reviewers.}
