...
The weak statistical fit of Model~2 compared to a log-linear benchmark (see Table~\ref{tab:likes}) cautions us aginst drawing quantitative conclusions from this model.
