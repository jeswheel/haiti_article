...
\author[B]{\fnms{AnnaElaine L.}~\snm{Rosengart}\ead[label=e2]{arosenga@andrew.cmu.edu}}
\author[A]{\fnms{Zhuoxun}~\snm{Jiang}\ead[label=e3]{zhuoxunj@umich.edu}},
\author[A]{\fnms{Kevin}~\snm{Tan}\ead[label=e4]{kevtan@umich.edu}},
\author[A]{\fnms{Noah}~\snm{Treutle}\ead[label=e5]{ntreutle@umich.edu}}
\and
\author[A]{\fnms{Edward L.}~\snm{Ionides}\ead[label=e6]{ionides@umich.edu}}

\address[A]{Statistics Department, University of Michigan\printead[presep={,\ }]{e1,e3,e4,e5,e6}}

\address[B]{Statistics \& Data Science Department, Carnegie Mellon University\printead[presep={,\ }]{e2}}
...
We implemented this model using the \code{spatPomp} \code{R} package \citep{asfaw23arxiv}.
...
\sdescription{
The \code{haitipkg} R package is maintained in a GitHub repository, \code{jeswheel/haitipkg}. The submitted version of this package is archived on Zenodo: \code{10.5281/zenodo.7557099}
