...
% The black curve represents true case count, the blue curve the median of 500 simulations from the model, and the gray ribbons representing $95\%$ confidence interval.
% }
% \end{figure}
