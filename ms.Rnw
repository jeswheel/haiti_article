%% Based on the template for the submission to:
...
# betaB + foi_add for all 10 units +
# aHur3, aHur9, hHur3, hHur9 +
# Iinit3, Iinit7, Iinit9 +
# shared_parameters
mod3_n_params <- 2 * 10 + 7 + length(shared_param_names)
...
set_rw_1 <- function(x) {
  ...
  } else if (x %in% c("Iinit3", "Iinit7", "Iinit10")) {
