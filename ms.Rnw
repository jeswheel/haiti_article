...
We further demonstrate the usefulness of recent advancements in likelihood optimization for high-dimensional nonlinear dynamic models, which enable improved consistency between high dimensional models and observed incidence data.}
\old{Our workflow is} \new{The presented case study is} reproducible and extendable, facilitating future investigations of this disease system.
