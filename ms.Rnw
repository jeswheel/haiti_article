...
Although several cholera cases have recently been detected in Haiti (\citep{world2010outbreak}),
their conclusion is inconsistent with the prolonged period with no confirmed cholera cases between February, 2019 \citep{trevisin22} and October, 2022.
...
In our literature review of the Haiti cholera epidemic, no benchmark models were considered in any of the 32 papers that used dynamic models to describe the cholera in order to obtain scientific conclusions.
