...
\new{The possibility of controling the Haiti cholera outbreak via OCV was considered by various research groups.} \TODO{Citations}. 
...
\jwc{This doesn't quite feel like the right place for this either, but I can't seem to pin down exactly where that would be yet. Perhaps the discussion?}
\new{\editMechModels}
