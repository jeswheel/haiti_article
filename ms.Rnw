...
The data that were used for this study, and that is the subject of our reanalysis, is displayed in Fig.~\ref{fig:CholeraData}.
...
\paragraph*{S5 Text}
\label{S_mod3cal}
{\bf Likelihood of Lee et al. models.} Additional details on the procedures for fitting and diagnosing Model~3.
