...
In the following subsections, complete descriptions of Models~1--3 are provided \eic{WE NEED INITIAL VALUES AND A MEASUREMENT MODEL TO COMPLETE THE DESCRIPTION. MAYBE WE JUST SAY WE'RE DESCRIBING THE DYNAMICS HERE, OR MAYBE WE ADD THE MISSING STUFF, WHICH HAS TO BE SOMEWHERE ANYHOW. SOME OF THIS IS DONE IN SEC 3.1.1 FOR MODEL 1, BUT PERHAPS BETTER TO DO IT SYSTEMATICALLY WHEN THE MODEL IS ORIGINALLY DEFINED.}.
...
This decision to address metapopulation dynamics via a spatially explicit model, rather than to aggregate over space, is double-edged.
