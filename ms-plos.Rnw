...
In this section, we make some general points on deriving scientific conclusions from statistical analysis of mechanistic models, and connect these points to our specific case study.
