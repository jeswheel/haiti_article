...
Additional details about the numeric implementation of these models are provided in Sec.~S1 and S2 of the supplemental text (\nameref{S1_Text}).
...
\paragraph*{S1 Text}
\label{S1_Text}
{\bf Supplemental Material.} In depth description of the numeric implementation of models.
